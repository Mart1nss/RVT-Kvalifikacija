...
<body>
    ...
    <div class="login-container" style="max-width: 520px;">
        ...
        <form method="POST" action="{{ route('password.email') }}">
            ...
            <button type="submit" class="btn-primary" style="width: 100%; margin-top: 20px; height: 48px">
                Send Password Reset Link
            </button>

            <button href="{{ route('login') }}" class="login-btn"
                style="margin-top: 10px; margin-left: 0px; width: 48%; display: inline-block; float: left; border: 2px solid white; height: 48px;"
                onclick="window.location.href='{{ route('login') }}'">Back to Login</button>
