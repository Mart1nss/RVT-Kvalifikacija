...
<body>
    ...
    <div class="under-pdf">
      ...
      <form class="review-form" method="POST" action="{{ route('products.reviews.store', $product->id) }}">
        ...
        <div class="star-rating">
          @for ($i = 5; $i >= 1; $i--)
        <input style="display: none;" type="radio" id="rating-{{ $i }}" name="review_score" value="{{ $i }}"
        required>
      ...
      @endfor
        ...
        <textarea class="review-textbox" name="review_text" placeholder="Write your review here..."
          required></textarea>
  ...
  @endauth
        <h3 style="margin-bottom: 8px; font-family: sans-serif; font-weight: 600; text-transform: uppercase;">Sort by
        </h3>
