  ...
  <div class="text-container">
    <div style="display: flex; justify-content: space-between; align-items: center;">
      ...
      <a href="{{ route('categories.index') }}"
        style="width: max-content; background-color: #1c1a1a; padding: 10px 20px; border-radius: 20px; text-decoration: none; color: white; font-family: sans-serif; font-weight: 800; font-size: 12px;">
        MANAGE CATEGORIES</a>
    </div>
  </div>
